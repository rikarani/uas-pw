...
$historys = fetch("SELECT * FROM pemesanan WHERE nama_pemesan = '$userLogin'");;
?>
...
<body class="min-h-full relative bg-slate-200 flex">
    ...
    <main class="container w-full h-full">
        ...
        <h5 class="text-3xl font-semibold mt-4 ml-3">Riwayat Pesanan</h5>

        <!-- Table -->
        <table class="bg-white text-center w-full mt-4">
            <thead>
                <tr>
                    <th>No.</th>
