  ...
  <main class="container max-w-2xl divide-y divide-black sm:rounded-lg bg-white box-border py-2 px-4">
    ...
    <form action="" method="POST">
      ...
      <div class="relative username mt-3">
        <input type="text" id="username" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
